"""
    Like V10 (demo V6) but with the same image-target pairs across model and budgets, a narrower budget regime, and start images of three types 
...
from wormholes.perturb.gen_v10 import GenV10
