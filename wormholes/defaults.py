...
TRAINING_ARGS = [
    ...
    ['balance-train', [0, 1], 'class sample balancing for training', 0],
    ['balance-val', [0, 1], 'class sample balancing for testing', 0],
...
MODEL_LOADER_ARGS = [
    ...
    ['pytorch-pretrained', [0, 1], 'load a standard-trained checkpoint from the torchvision library', 0],
